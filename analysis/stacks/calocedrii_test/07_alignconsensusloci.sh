...
FASTA=../results/calocedrii_test/populations.loci.fa
BAM=../results/calocedrii_test/populations.loci.bam
BED=../results/calocedrii_test/populations.loci.bed
BED2=../results/calocedrii_test/populations.loci.cutsites.bed
